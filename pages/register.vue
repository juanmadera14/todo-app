      ...
      <div class="col-lg-6 col-xs-12 mt-3">
        ...
        <form action="#" v-on:submit.prevent="registerUser" autocomplete="off">
          ...
          <div class="mb-3">
            ...
            <input type="text" id="full_name" name="full_name" placeholder="Ingres su nombre completo"
              v-model="fullName" class="form-control">
          </div>

          <div class="mb-3">
            <label for="email" class="form-label">Correo Electrónico</label>
            <input type="email" id="email" name="email" placeholder="Ingrese su correo electrónico" v-model="email"
              class="form-control">
          </div>
          ...
          <div class="mb-3">
            ...
            <div class="input-group mb-3">
              <input type="password" id="password" name="password" ref="password" placeholder="Ingrese contraseña"
          ...
          <div class="mt-3 mb-3">
            ...
            <input type="password" id="confirm_password" name="confirm_password" ref="confirm_password"
              placeholder="De nuevo contraseña" v-model="confirmPassword" class="form-control">
